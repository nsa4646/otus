...
*>e10.2.20.0/24       172.16.0.14                                    0 65002 i
*>e10.3.30.0/24       172.16.0.18                                    0 65003 i
*>e10.10.10.1/32      172.16.0.10                                    0 65001 i
*>e10.10.10.2/32      172.16.0.14                                    0 65002 i
*>e10.10.10.3/32      172.16.0.18                                    0 65003 i
...
10.1.10.0/24, ubest/mbest: 1/0
    *via 172.16.0.10, [20/0], 00:24:07, bgp-65004, external, tag 65001
10.2.20.0/24, ubest/mbest: 1/0
    *via 172.16.0.14, [20/0], 00:24:08, bgp-65004, external, tag 65002
10.3.30.0/24, ubest/mbest: 1/0
    *via 172.16.0.18, [20/0], 00:23:58, bgp-65004, external, tag 65003
...
10.10.10.5/32, ubest/mbest: 1/0
    *via 172.16.0.10, [20/0], 00:09:33, bgp-65004, external, tag 65001
```
#### Spine02
```
...
Spine02# sh ip bgp
   Network            Next Hop            Metric     LocPrf     Weight Path
*>e0.0.0.0/0          172.16.0.20                                    0 65003 65004 i
* e                   172.16.0.16                                    0 65002 65004 i
* e                   172.16.0.12                                    0 65001 65004 i
* e10.1.10.0/24       172.16.0.20                                    0 65003 65004 65001 i
* e                   172.16.0.16                                    0 65002 65004 65001 i
*>e                   172.16.0.12                                    0 65001 i
* e10.2.20.0/24       172.16.0.20                                    0 65003 65004 65002 i
*>e                   172.16.0.16                                    0 65002 i
* e                   172.16.0.12                                    0 65001 65004 65002 i
*>e10.3.30.0/24       172.16.0.20                                    0 65003 i
* e                   172.16.0.16                                    0 65002 65004 65003 i
* e                   172.16.0.12                                    0 65001 65004 65003 i
* e10.10.10.1/32      172.16.0.20                                    0 65003 65004 65001 i
* e                   172.16.0.16                                    0 65002 65004 65001 i
*>e                   172.16.0.12                                    0 65001 i
* e10.10.10.2/32      172.16.0.20                                    0 65003 65004 65002 i
*>e                   172.16.0.16                                    0 65002 i
* e                   172.16.0.12                                    0 65001 65004 65002 i
*>e10.10.10.3/32      172.16.0.20                                    0 65003 i
* e                   172.16.0.16                                    0 65002 65004 65003 i
* e                   172.16.0.12                                    0 65001 65004 65003 i
*>e10.10.10.4/32      172.16.0.20                                    0 65003 65004 i
* e                   172.16.0.16                                    0 65002 65004 i
* e                   172.16.0.12                                    0 65001 65004 i
...
0.0.0.0/0, ubest/mbest: 1/0
    *via 172.16.0.20, [20/0], 00:08:59, bgp-65005, external, tag 65003
10.1.10.0/24, ubest/mbest: 1/0
    *via 172.16.0.12, [20/0], 00:08:57, bgp-65005, external, tag 65001
10.2.20.0/24, ubest/mbest: 1/0
    *via 172.16.0.16, [20/0], 00:08:58, bgp-65005, external, tag 65002
10.3.30.0/24, ubest/mbest: 1/0
    *via 172.16.0.20, [20/0], 00:08:59, bgp-65005, external, tag 65003
10.10.10.1/32, ubest/mbest: 1/0
    *via 172.16.0.12, [20/0], 00:08:57, bgp-65005, external, tag 65001
...
Leaf01# sh ip bgp
   Network            Next Hop            Metric     LocPrf     Weight Path
*>e0.0.0.0/0          172.16.0.11                                    0 65004 i
* e                   172.16.0.13                                    0 65005 i
*>l10.1.10.0/24       0.0.0.0                           100      32768 i
*>e10.2.20.0/24       172.16.0.11                                    0 65004 65002 i
* e                   172.16.0.13                                    0 65005 65002 i
*>e10.3.30.0/24       172.16.0.11                                    0 65004 65003 i
* e                   172.16.0.13                                    0 65005 65003 i
*>l10.10.10.1/32      0.0.0.0                           100      32768 i
*>e10.10.10.2/32      172.16.0.11                                    0 65004 65002 i
* e                   172.16.0.13                                    0 65005 65002 i
*>e10.10.10.3/32      172.16.0.11                                    0 65004 65003 i
* e                   172.16.0.13                                    0 65005 65003 i
...
0.0.0.0/0, ubest/mbest: 1/0
    *via 172.16.0.11, [20/0], 00:37:21, bgp-65001, external, tag 65004
10.2.20.0/24, ubest/mbest: 1/0
    *via 172.16.0.11, [20/0], 00:37:21, bgp-65001, external, tag 65004
10.3.30.0/24, ubest/mbest: 1/0
    *via 172.16.0.11, [20/0], 00:37:21, bgp-65001, external, tag 65004
...
10.10.10.4/32, ubest/mbest: 1/0
    *via 172.16.0.11, [20/0], 00:37:21, bgp-65001, external, tag 65004
10.10.10.5/32, ubest/mbest: 1/0
    *via 172.16.0.13, [20/0], 00:37:20, bgp-65001, external, tag 65005
```
#### Leaf02
```
...
*>e10.3.30.0/24       172.16.0.15                                    0 65004 650
03 i
...
0.0.0.0/0, ubest/mbest: 1/0
    *via 172.16.0.15, [20/0], 00:38:48, bgp-65002, external, tag 65004
10.1.10.0/24, ubest/mbest: 1/0
    *via 172.16.0.15, [20/0], 00:26:49, bgp-65002, external, tag 65004
10.3.30.0/24, ubest/mbest: 1/0
    *via 172.16.0.15, [20/0], 00:11:19, bgp-65002, external, tag 65004
10.10.10.1/32, ubest/mbest: 1/0
    *via 172.16.0.15, [20/0], 00:26:49, bgp-65002, external, tag 65004
10.10.10.3/32, ubest/mbest: 1/0
    *via 172.16.0.15, [20/0], 00:11:19, bgp-65002, external, tag 65004
10.10.10.4/32, ubest/mbest: 1/0
    *via 172.16.0.15, [20/0], 00:26:49, bgp-65002, external, tag 65004
10.10.10.5/32, ubest/mbest: 1/0
    *via 172.16.0.17, [20/0], 00:38:48, bgp-65002, external, tag 65005
```
#### Leaf03
```
...
BGP table version is 160, Local Router ID is 10.10.10.3
...
est2
   ...
   Network            Next Hop            Metric     LocPrf     Weight Path
*>e0.0.0.0/0          172.16.0.19                                    0 65004 i
* e                   172.16.0.21                                    0 65005 i
*>e10.1.10.0/24       172.16.0.19                                    0 65004 65001 i
* e                   172.16.0.21                                    0 65005 65001 i
*>e10.2.20.0/24       172.16.0.19                                    0 65004 65002 i
* e                   172.16.0.21                                    0 65005 65002 i
*>l10.3.30.0/24       0.0.0.0                           100      32768 i
*>e10.10.10.1/32      172.16.0.19                                    0 65004 65001 i
* e                   172.16.0.21                                    0 65005 65001 i
*>e10.10.10.2/32      172.16.0.19                                    0 65004 65002 i
* e                   172.16.0.21                                    0 65005 65002 i
*>l10.10.10.3/32      0.0.0.0                           100      32768 i
*>e10.10.10.4/32      172.16.0.19                                    0 65004 i
* e                   172.16.0.21                                    0 65005 65001 65004 i
* e10.10.10.5/32      172.16.0.19                                    0 65004 65001 65005 i
*>e                   172.16.0.21                                    0 65005 i
```
```
Leaf03# sh ip route bgp
0.0.0.0/0, ubest/mbest: 1/0
    *via 172.16.0.19, [20/0], 00:39:54, bgp-65003, external, tag 65004
10.1.10.0/24, ubest/mbest: 1/0
    *via 172.16.0.19, [20/0], 00:39:54, bgp-65003, external, tag 65004
10.2.20.0/24, ubest/mbest: 1/0
    *via 172.16.0.19, [20/0], 00:39:54, bgp-65003, external, tag 65004
...
10.10.10.4/32, ubest/mbest: 1/0
    *via 172.16.0.19, [20/0], 00:39:54, bgp-65003, external, tag 65004
10.10.10.5/32, ubest/mbest: 1/0
    *via 172.16.0.21, [20/0], 00:12:01, bgp-65003, external, tag 65005
```