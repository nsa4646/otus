 ...
 * >     RD: 10.10.10.2:10020 imet 10.10.11.2
                                 -                     -       -       0       i
```  
### Вывод связности между устройствами PC1, PC2, PC3, PC4
#### PC1
![PC1](PC1.PNG)
...
no vlan 20
   vlan-aware-bundle BUNDLE
      ...
      vlan 10,20
```
Связность не нарушилась. Устройства PC1, PC4 и PC2, PC3 пингуют друг друга в своем широковещательном домене.